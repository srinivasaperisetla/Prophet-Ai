...
export const BaseTokenPackCard = () => {
  ...
  return (
    <div className="rounded-lg border border-zinc-800/50 bg-zinc-800/50 p-6 transition-colors hover:border-purple-500/50">
      <div className="mt-2 text-center">
        ...
        <h3 className="mt-2 mb-2 text-2xl font-bold text-white">Base Pack</h3>
        ...
        <div className="space-y-3 text-left">
          ...
          <div className="flex items-center gap-2">
            <Check className="h-4 w-4 text-green-400" />
            <span className="text-white">$0.01 per Token</span>
          </div>
          <div className="flex items-center gap-2">
            <Check className="h-4 w-4 text-green-400" />
            <span className="text-white">
              Best For: Consistent casual usage
            </span>
          </div>
