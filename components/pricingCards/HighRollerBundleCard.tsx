...
export const HighRollerBundleCard = () => {
      ...
      <div className="mt-2 text-center">
        ...
        <div className="space-y-3 text-left">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white">7,500 Tokens</span>
          </div>
          <div className="flex items-center gap-2">
            <Check className="h-4 w-4 text-green-400" />
            <span className="text-white">$0.0067 per Token</span>
          </div>
          <div className="flex items-center gap-2">
            <Check className="h-4 w-4 text-green-400" />
            <span className="text-white">
              Best For: Heavy users needing bulk tokens
            </span>
          </div>
